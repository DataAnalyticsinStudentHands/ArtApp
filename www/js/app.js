...
angular.module('publicArtApp', [
    ...
    $stateProvider
        ...
        .state('search.artwork', {
            ...
            views: {
                "content": {
                    templateUrl: "templates/search.artwork.html"
                }
            }
    ...
    .run(function ($rootScope, $http, $ionicPlatform) {
        ...
        if (localStorage.getItem("tours_version") !== "1.0") {
            $http.get('json/tours.json').success(function (data) {
        ...
        $rootScope.isFocused = function (id) {
            var q;
            for (q = 0; q < $rootScope.focusedArt.length; q++) {
